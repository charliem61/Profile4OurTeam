...
To create an application that uses Jest for running the unit tests and Inquirer for collecting input from the user. The application will be started by us
